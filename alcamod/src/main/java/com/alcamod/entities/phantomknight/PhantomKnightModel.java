...
public class PhantomKnightModel extends EntityModel<PhantomKnightEntity> {
	...
	@Override
	public void setupAnim(PhantomKnightEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks,
